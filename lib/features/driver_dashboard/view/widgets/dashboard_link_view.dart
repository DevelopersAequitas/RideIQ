...
Widget _buildPlatformLinkCard({
  ...
  if (isConnected && truvState.reportData != null) {
    try {
      final employments = truvState.reportData!['data']['employments'] as List;
      ...
      children: [
        ClipRRect(
          ...
          child: Container(
            width: 48.w,
            height: 48.w,
            color: (name.toLowerCase() == "uber" || name.toLowerCase() == "ayro") ? Colors.black : const Color(0xFFFF00BF),
            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  Flexible(
                    child: Text(
                      isConnected ? l10n.connected : status,
                      maxLines: 1,
