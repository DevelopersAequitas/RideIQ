...
Widget _buildEarningsRow(
  ...
  final isBlackBackground = name.toLowerCase() == "uber" || name.toLowerCase() == "ayro";
  return GestureDetector(
    ...
    child: AnimatedContainer(
      ...
      decoration: BoxDecoration(
        color: isSelected ? Color(0xFFE8F2FF) : AppColors.surface,
        borderRadius: BorderRadius.circular(16.w),
        border: Border.all(
          color: isSelected ? const Color(0xFF1E74E9) : AppColors.surface,
        ...
        children: [
          ClipRRect(
            ...
            child: Container(
              width: 36.w,
              height: 36.w,
              color: isBlackBackground ? Colors.black : const Color(0xFFFF00BF),
